...
Example Situation: medical systems have to consider whether an "assistant" for doctors when diagnosing patients is going to work. Key questions for them are what happens if there is a bug in the software, if someone screws up entering in data, how the technology is built, how will the front-end look, who is liable if things go wrong.
